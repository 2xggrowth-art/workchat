...
export default function VoiceNotePlayer({ src }: VoiceNotePlayerProps) {
  ...
  return (
    <div className="flex items-center gap-2.5 min-w-[180px] py-1">
      <button
        onClick={togglePlay}
        className="w-8 h-8 rounded-full flex items-center justify-center flex-shrink-0 bg-teal-600"
      >
        {isPlaying ? (
      ...
      <div className="flex-1 min-w-0">
        <div
          className="h-[6px] bg-gray-300 dark:bg-gray-600 rounded-full cursor-pointer relative overflow-hidden"
          onClick={handleSeek}
        >
          <div
